...
plt.savefig('../Plots/Fig_Main_v03/Fig01_v03.pdf',dpi=200)
plt.close()
...
plt.savefig('../Plots/Fig_Main_v03/Fig02a_v03.pdf',dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    # I save
    plt.savefig('../Plots/Fig_Main_v03/Fig02%s_v03.pdf' % parameter_panellabel_list[ipar],dpi=200)
    plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Fig02e_v03.pdf' ,dpi=200)
plt.close()
...
plt.savefig('../Plots/Fig_Main_v03/Fig03a_v03.pdf'  ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v03/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_Fig02_v03.pdf' , dpi=200)
plt.close()
...
# I add the grid
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Fig03b_v03.pdf' ,dpi=200)
plt.close()
...
def carbon_budget_calculation(dens0,densf,day0,dayf):
    ...
    return Theoretical_Budget,Theoretical_Budget_std, \
           ...
           Delta_Integrated_POC, Delta_Integrated_POC_std, Delta_flux, Delta_flux_std,Flux_dens0_mgC_m3_d,Flux_densf_mgC_m3_d, \
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Fig04_v03.pdf' ,dpi=200)
plt.close()


########################################################################################################################
######### Fig. Supplementary Extended size spectrum
########################################################################################################################
idx1,idx2=0,38
set_ylim_lower=depth_isopycnal_list[idx1]
set_ylim_upper=depth_isopycnal_list[idx2]
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Supplementary/Suppl_CarbBudgetExtended_v03.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Supplementary/Suppl_CarbBudget_TW2_v03.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Supplementary/Suppl_CarbBudgetExtended_TW2_v03.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v03/Supplementary/Supplementary_Fig02_v03.pdf' ,dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    # I save
    plt.savefig('../Plots/Fig_Main_v03/Supplementary/TimeSeries_ML/TimeSeries_ML_%s_Fig02_v03.pdf' % parameter_shortname_list[ipar], dpi=200)
    plt.close()
    ...
    if ipar == 1:
        ...
        plt.grid(color='k', linestyle='dashed', linewidth=0.5)
        # I save
        plt.savefig('../Plots/Fig_Main_v03/Supplementary/TimeSeries_ML/TimeSeries_ML_chla_integrated_Fig02_v03.pdf', dpi=200)
        plt.close()
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    # I save
    plt.savefig('../Plots/Fig_Main_v03/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_%s_Fig02_v03.pdf' % parameter_shortname_list[ipar], dpi=200)
    plt.close()
