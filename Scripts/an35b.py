...
for index_day in range(day0,dayf+1):
    ...
    os.system("mv %s ../Data/an35/Daily/" % (filename))
...
for index_day in range(day0,dayf+1):
    ...
    ds = nc.Dataset("../Data/an35/Daily/%s" % (filename))
    ...
    ds.close()
    ds = nc.Dataset("../Data/an35/Daily/%s" % (filenameB),mode='w')
    ...
    zeu[:,:] = zeu2
    ds.close()
    os.system("rm -f ../Data/an35/Daily/%s" % (filename))
    os.system("mv ../Data/an35/Daily/%s ../Data/an35/Daily/%s" % (filenameB,filename))
