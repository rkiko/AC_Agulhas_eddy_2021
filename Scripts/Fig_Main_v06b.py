...
plt.savefig('../Plots/Fig_Main_v06b/Fig01_v06b.pdf',dpi=200)
plt.close()
# endregion
# endregion
...
plt.savefig('../Plots/Fig_Main_v06b/Fig02a_v06b.pdf',dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I save
    if ipar<5:
        plt.savefig('../Plots/Fig_Main_v06b/Fig02%s_v06b.pdf' % parameter_savelabel_list[ipar],dpi=200)
    else:
        plt.savefig('../Plots/Fig_Main_v06b/Supplementary/SupplFig_salinity_time_depth_v06b.pdf',dpi=200)
    plt.close()
...
# plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# plt.savefig('../Plots/Fig_Main_v06b/Fig02e_Cetinic_v06b.pdf' ,dpi=200)
# plt.close()
...
ax.text(-0.075, 1.05, 'e', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Fig02e_Koestner_v06b.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.075, 1.05, 'a', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/MiPMaPbbpPOC_Koestner_ML_v06b.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/MiPMaPbbpPOC_Koestner_EC_v06b.pdf' ,dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I add the grid
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/Fig_Main_v06b/Fig02%s_v06b.pdf' % (parameter_panellabel_list[ipar]),dpi=200)
    plt.close()
...
plt.savefig('../Plots/Fig_Main_v06b/Fig03a_v06b.pdf'  ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_v06b.pdf' , dpi=200)
plt.close()
...
# I add the grid
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Fig03b_v06b.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Fig04A_Koestner_v06bb.pdf' ,dpi=200)
plt.close()


########################################################################################################################
######### Fig. 4B: Extended size spectrum with BBP from Koestner
########################################################################################################################
idx1,idx2=0,38
set_ylim_lower=depth_isopycnal_list[idx1]
set_ylim_upper=depth_isopycnal_list[idx2]
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Fig04B_Koestner_v06b.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/Fig04A_Cetinic_v06b.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/Fig04A_noBBP_v06b.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/Suppl_CarbBudgetExtended_Cetinic_v06b.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06b/Supplementary/Suppl_CarbBudgetExtended_noBBP_v06b.pdf' ,dpi=200)
plt.close()
