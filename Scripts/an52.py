...
ax1 = fig.add_axes([0.25, 0.15, width, height], ylim=(0, 1000))#, xlim=(0, 23))
fig = plt.figure(2, figsize=(3, 3))
ax2 = fig.add_axes([0.25, 0.15, width, height], ylim=(0, 1000))#, xlim=(0, 23))
fig = plt.figure(3, figsize=(3, 3))
ax3 = fig.add_axes([0.25, 0.15, width, height], ylim=(0, 1000))#, xlim=(0, 10)
...
plt.savefig('%s/BTempVsPres_an52.pdf' % (plotdir), dpi=200)
plt.close()
...
plt.savefig('%s/BSalVsPres_an52.pdf' % (plotdir), dpi=200)
plt.close()
...
plt.savefig('%s/BDoxyVsPres_an52.pdf' % (plotdir), dpi=200)
plt.close()
...
plt.savefig('%s/BTempVsSal_an52.pdf' % (plotdir), dpi=200)
plt.close()
