...
for ndays in ndays_list:
    ...
    ax.text(-0.05, 1.125, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/an67/CarbonBudget_vs_depth_IMday%d%02d%02d_TW1_from%d%02d%02d_0103_an67.pdf' % (dayf1.year,dayf1.month,dayf1.day,day0.year,day0.month,day0.day) ,dpi=200)
    plt.close()
