...
dayf=datetime(2021,9,9)        # starting date for the carbon budget calculation
...
for ndays in ndays_list:
    ...
    for depth0 in depth0_list:
        ...
        Theoretical_Budget_std_list_w2=np.append(Theoretical_Budget_std_list_w2,Theoretical_Budget_std)
        Theoretical_Budget_eta_b_std_list_w2=np.append(Theoretical_Budget_eta_b_std_list_w2,Theoretical_Budget_eta_b_std)
    ...
    plt.savefig('../Plots/an34b/CarbonBudget_vs_depth_IMday%d%02d%02d_TW1_from%d%02d%02d_0101eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,day0.year,day0.month,day0.day) ,dpi=200)
    plt.close()
    ...
    ax.text(-0.05, 1.125, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/an34b/CarbonBudget_vs_depth_IMday%d%02d%02d_TW2_to%d%02d%02d_0101eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,dayf.year,dayf.month,dayf.day) ,dpi=200)
    plt.close()
    ...
    plt.savefig('../Plots/an34b/WithStatisticalDifference/CarbonBudget_vs_depth_IMday%d%02d%02d_TW1_from%d%02d%02d_0201eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,day0.year,day0.month,day0.day) ,dpi=200)
    plt.close()
    ...
    ax[1].text(-0.2, -0.040, 'Statistical\ndifference', transform=ax[1].transAxes, fontsize=9, va='top',
               ha='left')  # ,fontfamily='helvetica'
    plt.savefig('../Plots/an34b/WithStatisticalDifference/CarbonBudget_vs_depth_IMday%d%02d%02d_TW2_to%d%02d%02d_0201eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,dayf.year,dayf.month,dayf.day) ,dpi=200)
    plt.close()
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/an34b/CarbonBudget_vs_depth_IMday%d%02d%02d_TW1_from%d%02d%02d_0102extended_eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,day0.year,day0.month,day0.day) ,dpi=200)
    plt.close()
    ...
    ax.text(-0.05, 1.125, 'c', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/an34b/CarbonBudget_vs_depth_IMday%d%02d%02d_TW2_to%d%02d%02d_0102extended_eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,dayf.year,dayf.month,dayf.day) ,dpi=200)
    plt.close()
    ...
    ax[1].text(-0.2, -0.040, 'Statistical\ndifference', transform=ax[1].transAxes, fontsize=9, va='top',
               ha='left')  # ,fontfamily='helvetica'
    plt.savefig('../Plots/an34b/WithStatisticalDifference/CarbonBudget_vs_depth_IMday%d%02d%02d_TW1_from%d%02d%02d_0202extended_eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,day0.year,day0.month,day0.day) ,dpi=200)
    plt.close()
    ...
    ax[1].text(-0.2, -0.040, 'Statistical\ndifference', transform=ax[1].transAxes, fontsize=9, va='top',
               ha='left')  # ,fontfamily='helvetica'
    plt.savefig('../Plots/an34b/WithStatisticalDifference/CarbonBudget_vs_depth_IMday%d%02d%02d_TW2_to%d%02d%02d_0202extended_eta_b_an34b.pdf' % (dayf1.year,dayf1.month,dayf1.day,dayf.year,dayf.month,dayf.day) ,dpi=200)
    plt.close()
