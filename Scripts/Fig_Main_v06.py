...
plt.savefig('../Plots/Fig_Main_v06/Fig02a_v06.pdf',dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I save
    if ipar<5:
        plt.savefig('../Plots/Fig_Main_v06/Fig02%s_v06.pdf' % parameter_savelabel_list[ipar],dpi=200)
    else:
        plt.savefig('../Plots/Fig_Main_v06/Supplementary/SupplFig_salinity_time_depth_v06.pdf',dpi=200)
    plt.close()
...
ax.text(-0.075, 1.05, 'e', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Fig02e_Koestner_v06.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.075, 1.05, 'a', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/MiPMaPbbpPOC_Koestner_ML_v06.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/MiPMaPbbpPOC_Koestner_EC_v06.pdf' ,dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I add the grid
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/Fig_Main_v06/Fig02%s_v06.pdf' % (parameter_panellabel_list[ipar]),dpi=200)
    plt.close()
...
plt.savefig('../Plots/Fig_Main_v06/Fig03a_v06.pdf'  ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v06/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_v06.pdf' , dpi=200)
plt.close()
...
# I add the grid
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Fig03b_v06.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/Fig04A_Cetinic_v06.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/Fig04A_noBBP_v06.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/Suppl_CarbBudgetExtended_Cetinic_v06.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v06/Supplementary/Suppl_CarbBudgetExtended_noBBP_v06.pdf' ,dpi=200)
plt.close()
