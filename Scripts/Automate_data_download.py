...
if __name__ == '__main__':
    ...
    os.system("python Append_BGC_variables.py %s %d" % (filename_processed,id_BGCArgo))
    ...
    os.system("python Append_BGC_variables_to_diagnostics.py %s %d" % (filename_diagnostics,id_BGCArgo))
