...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I save
    plt.savefig('../Plots/an17/TimeSeries_%s_vs_01depth_an17.pdf' % parameter_shortname_list[ipar],dpi=200)
    plt.close()
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    # I save
    plt.savefig('../Plots/an17/TimeSeries_%s_vs_02dens_an17.pdf' % parameter_shortname_list[ipar],dpi=200)
    plt.close()
