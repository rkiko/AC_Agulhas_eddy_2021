...
parameter_panellabel_list=['b','a','d','c','f','a']
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    set_ylim_lower, set_ylim_upper = y1_parameter.min(),1000
    ...
    # I save
    plt.savefig('../Plots/an17B/TimeSeries_%s_vs_01depth_an17B.pdf' % parameter_shortname_list[ipar],dpi=200)
    plt.close()
    ...
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    # I save
    plt.savefig('../Plots/an17B/TimeSeries_%s_vs_02dens_an17B.pdf' % parameter_shortname_list[ipar],dpi=200)
    plt.close()
