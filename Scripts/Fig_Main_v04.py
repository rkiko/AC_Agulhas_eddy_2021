...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v04/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_v04.pdf' , dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Supplementary_v04.pdf' ,dpi=200)
plt.close()
