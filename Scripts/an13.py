...
ax[0].plot(slopes_list, depth_isopycnal, 'k')#, linestyle='dashed')
ax[0].scatter(slopes_list, depth_isopycnal, c='black',s=5)
ax[0].fill_betweenx(depth_isopycnal,slopes_ci_list[:,1],slopes_ci_list[:,0],facecolor='b',color='gray',alpha=0.5,label='O$_2$')
