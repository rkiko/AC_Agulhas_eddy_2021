...
plt.savefig('../Plots/Fig_Main_v04/Fig01_v04.pdf',dpi=200)
plt.close()
...
plt.savefig('../Plots/Fig_Main_v04/Fig02a_v04.pdf',dpi=200)
plt.close()
...
plt.savefig('../Plots/Fig_Main_v04/Fig03a_v04.pdf'  ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v04/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_Fig02_v04.pdf' , dpi=200)
plt.close()
...
# I add the grid
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Fig03b_v04.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Fig04_Cetinic_v04.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Fig04_noBBP_v04.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Fig04_Koestner_v04.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Suppl_CarbBudgetExtended_Cetinic_v04.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Suppl_CarbBudgetExtended_noBBP_v04.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Suppl_CarbBudgetExtended_Koestner_v04.pdf' ,dpi=200)
plt.close()
...
# Parameters for the carbon budget calculation
#######################################################################
day0=datetime.datetime(2021,8,1)        # starting date for the carbon budget calculation
dayf=datetime.datetime(2021,9,23)        # starting date for the carbon budget calculation
ndays=(dayf-day0).days          # number of days
dens00=1026.3                   # starting isopycnal
dens_thickness=0.05             # thickness of the layer considered (in kg/m3)
delta_dens=0.025                 # every time I do a loop, how much I do increase depth0
...
########################################################################################################################
######### Carbon budget second time window
########################################################################################################################
idx1,idx2=0,38
set_ylim_lower=depth_isopycnal_list[idx1]
set_ylim_upper=depth_isopycnal_list[idx2]
...
ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Suppl_CarbBudget_TW2_v04.pdf' ,dpi=200)
plt.close()


########################################################################################################################
######### Fig. Carbon budget second time window with extended size spectrum
########################################################################################################################
idx1,idx2=0,38
set_ylim_lower=depth_isopycnal_list[idx1]
set_ylim_upper=depth_isopycnal_list[idx2]
...
# plt.savefig('../Plots/Supplementary/Anom_ConsTemp_v04.pdf',dpi=200)
# plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v04/Supplementary/Supplementary_Fig02_v04.pdf' ,dpi=200)
plt.close()
