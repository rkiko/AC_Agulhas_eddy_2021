...
plt.savefig('../Plots/Fig_Main_v05/Fig01_v05.pdf',dpi=200)
plt.close()
...
plt.savefig('../Plots/Fig_Main_v05/Fig02a_v05.pdf',dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I save
    if ipar<5:
        plt.savefig('../Plots/Fig_Main_v05/Fig02%s_v05.pdf' % parameter_savelabel_list[ipar],dpi=200)
    else:
        plt.savefig('../Plots/Fig_Main_v05/Supplementary/SupplFig_salinity_time_depth_v05.pdf',dpi=200)
    plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig02e_Cetinic_v05.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.075, 1.05, 'e', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig02e_Koestner_v05.pdf' ,dpi=200)
plt.close()
...
ax.text(-0.075, 1.05, 'a', transform=ax.transAxes,fontsize=34, fontweight='bold', va='top', ha='right') # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Supplementary/MiPMaPbbpPOC_Koestner_ML_v05.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Supplementary/MiPMaPbbpPOC_Koestner_EC_v05.pdf' ,dpi=200)
plt.close()
...
for ipar in range(0,parameter_ylabel_list.__len__()):
    ...
    # I add the grid
    plt.grid(color='k', linestyle='dashed', linewidth=0.5)
    plt.savefig('../Plots/Fig_Main_v05/Fig02%s_v05.pdf' % (parameter_panellabel_list[ipar]),dpi=200)
    plt.close()
...
plt.savefig('../Plots/Fig_Main_v05/Fig03a_v05.pdf'  ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
# I save
plt.savefig('../Plots/Fig_Main_v05/Supplementary/TimeSeries_EddyCore/TimeSeries_EddyCore_Flux_v05.pdf' , dpi=200)
plt.close()
...
# I add the grid
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig03b_v05.pdf' ,dpi=200)
plt.close()
...
def carbon_budget_calculation(dens0,densf,day0,dayf):
    ...
    # Integrated_POC_day0_mgC_m3_d = Integrated_POC_mgC_m3[0] / ndays# * layer_thickness
    # Integrated_POC_dayf_mgC_m3_d = Integrated_POC_mgC_m3[-1] / ndays# * layer_thickness
    # Integrated_POC_day0_mgC_m3_d_std = Integrated_POC_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_dayf_mgC_m3_d_std = Integrated_POC_mgC_m3_std[-1] / ndays # * layer_thickness
    # Integrated_POC_noBBP_day0_mgC_m3_d = Integrated_POC_noBBP_mgC_m3[0] / ndays# * layer_thickness
    # Integrated_POC_noBBP_dayf_mgC_m3_d = Integrated_POC_noBBP_mgC_m3[-1] / ndays# * layer_thickness
    # Integrated_POC_noBBP_day0_mgC_m3_d_std = Integrated_POC_noBBP_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_noBBP_dayf_mgC_m3_d_std = Integrated_POC_noBBP_mgC_m3_std[-1] / ndays # * layer_thickness
    # Integrated_POC_Koestner_day0_mgC_m3_d = Integrated_POC_Koestner_mgC_m3[0] / ndays# * layer_thickness
    # Integrated_POC_Koestner_dayf_mgC_m3_d = Integrated_POC_Koestner_mgC_m3[-1] / ndays# * layer_thickness
    # Integrated_POC_Koestner_day0_mgC_m3_d_std = Integrated_POC_Koestner_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_Koestner_dayf_mgC_m3_d_std = Integrated_POC_Koestner_mgC_m3_std[-1] / ndays # * layer_thickness
    ...
    # Old way of calculate the integrated POC between day and dayf, based on using the exact value on day0 and dayf, respectively
    # Integrated_POC_extended_day0_mgC_m3_d = Integrated_POC_extended_mgC_m3[0] / ndays # * layer_thickness
    # Integrated_POC_extended_dayf_mgC_m3_d = Integrated_POC_extended_mgC_m3[-1] / ndays # * layer_thickness
    # Integrated_POC_extended_day0_mgC_m3_d_std = Integrated_POC_extended_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_extended_dayf_mgC_m3_d_std = Integrated_POC_extended_mgC_m3_std[-1] / ndays # * layer_thickness
    # Integrated_POC_noBBP_extended_day0_mgC_m3_d = Integrated_POC_noBBP_extended_mgC_m3[0] / ndays # * layer_thickness
    # Integrated_POC_noBBP_extended_dayf_mgC_m3_d = Integrated_POC_noBBP_extended_mgC_m3[-1] / ndays # * layer_thickness
    # Integrated_POC_noBBP_extended_day0_mgC_m3_d_std = Integrated_POC_noBBP_extended_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_noBBP_extended_dayf_mgC_m3_d_std = Integrated_POC_noBBP_extended_mgC_m3_std[-1] / ndays # * layer_thickness
    # Integrated_POC_Koestner_extended_day0_mgC_m3_d = Integrated_POC_Koestner_extended_mgC_m3[0] / ndays # * layer_thickness
    # Integrated_POC_Koestner_extended_dayf_mgC_m3_d = Integrated_POC_Koestner_extended_mgC_m3[-1] / ndays # * layer_thickness
    # Integrated_POC_Koestner_extended_day0_mgC_m3_d_std = Integrated_POC_Koestner_extended_mgC_m3_std[0] / ndays # * layer_thickness
    # Integrated_POC_Koestner_extended_dayf_mgC_m3_d_std = Integrated_POC_Koestner_extended_mgC_m3_std[-1] / ndays # * layer_thickness
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig04_Cetinic_v05.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig04_noBBP_v05.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'a', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Fig04_Koestner_v05.pdf' ,dpi=200)
plt.close()
...
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Supplementary/Suppl_CarbBudgetExtended_Cetinic_v05.pdf' ,dpi=200)
plt.close()

########################################################################################################################
######### Fig. Supplementary Extended size spectrum: without bbpPOC
########################################################################################################################
idx1,idx2=0,38
set_ylim_lower=depth_isopycnal_list[idx1]
set_ylim_upper=depth_isopycnal_list[idx2]
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Supplementary/Suppl_CarbBudgetExtended_noBBP_v05.pdf' ,dpi=200)
plt.close()
...
# ax.text(-0.25, 1.075, 'b', transform=ax.transAxes, fontsize=18, fontweight='bold',va='top', ha='right')  # ,fontfamily='helvetica'
plt.grid(color='k', linestyle='dashed', linewidth=0.5)
plt.savefig('../Plots/Fig_Main_v05/Supplementary/Suppl_CarbBudgetExtended_Koestner_v05.pdf' ,dpi=200)
plt.close()
...
arg_value=POC_resp_mgC_m3_d[2]
write_latex_data(filename,argument,'%0.4f' % arg_value)
argument = 'PARR_0413to0731_eddycore_std'
arg_value=POC_resp_mgC_m3_d_std[2]
write_latex_data(filename,argument,'%0.4f' % arg_value)
