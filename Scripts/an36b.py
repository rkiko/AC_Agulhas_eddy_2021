...
dayf=(2021,9,23) # Last day for which I calculate the euphotic depth
#######################################################################
...
year=2021
filename0_zeu='A'
filename2_zeu = 'L3m_DAY_ZLEE_Zeu_lee_9km.nc'
ray_neighborhood=0.5
delta0 = 0.01
...
for i in range(0,Date_Num.size):
    ...
    filename_zeu = '%s%d%03d.%s' % (filename0_zeu, year, index_day, filename2_zeu)
    ds = nc.Dataset("../Data/an35/Daily/%s" % (filename_zeu))
